...
import by.victory.myapp.domain.Address;
import by.victory.myapp.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().country(DEFAULT_COUNTRY).city(DEFAULT_CITY).postcode(DEFAULT_POSTCODE);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().country(UPDATED_COUNTRY).city(UPDATED_CITY).postcode(UPDATED_POSTCODE);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.country(UPDATED_COUNTRY).city(UPDATED_CITY).postcode(UPDATED_POSTCODE);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).postcode(UPDATED_POSTCODE);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.country(UPDATED_COUNTRY).city(UPDATED_CITY).postcode(UPDATED_POSTCODE);
