...
describe('StatementType e2e test', () => {
  ...
  const statementTypeSample = { name: 'bah' };
  ...
  describe('StatementType page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit StatementType page and go back', () => {
      ...
      it('edit button click should load edit StatementType page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('StatementType');
  ...
  describe('new StatementType page', () => {
    ...
    it('should create an instance of StatementType', () => {
      cy.get(`[data-cy="name"]`).type('gadzooks at book');
      cy.get(`[data-cy="name"]`).should('have.value', 'gadzooks at book');
