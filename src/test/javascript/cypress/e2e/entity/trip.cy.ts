...
describe('Trip e2e test', () => {
  ...
  const tripSample = { authorizedCapital: 27548.24, threshold: 6730.33 };
  ...
  describe('new Trip page', () => {
    ...
    it('should create an instance of Trip', () => {
      cy.get(`[data-cy="authorizedCapital"]`).type('25448.39');
      cy.get(`[data-cy="authorizedCapital"]`).should('have.value', '25448.39');

      cy.get(`[data-cy="threshold"]`).type('19861.15');
      cy.get(`[data-cy="threshold"]`).should('have.value', '19861.15');
