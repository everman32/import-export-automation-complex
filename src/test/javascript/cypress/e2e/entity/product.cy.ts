...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'politely promptly', costPerPiece: 12600.5 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('sport');
      cy.get(`[data-cy="name"]`).should('have.value', 'sport');

      cy.get(`[data-cy="costPerPiece"]`).type('16000.78');
      cy.get(`[data-cy="costPerPiece"]`).should('have.value', '16000.78');
