...
describe('Grade e2e test', () => {
  ...
  const gradeSample = { description: 'Vermont Refined cross-platform' };
  ...
  describe('Grade page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Grade page', () => {
  ...
  describe('new Grade page', () => {
    ...
    it('should create an instance of Grade', () => {
      cy.get(`[data-cy="description"]`).type('purple Avon cross-platform').should('have.value', 'purple Avon cross-platform');
