...
describe('ProductUnit e2e test', () => {
  ...
  const productUnitSample = { name: 'Towels Licensed', description: 'heuristic Bedfordshire Customer-focused' };
  ...
  describe('ProductUnit page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit ProductUnit page', () => {
  ...
  describe('new ProductUnit page', () => {
    ...
    it('should create an instance of ProductUnit', () => {
      cy.get(`[data-cy="name"]`).type('Supervisor Loan').should('have.value', 'Supervisor Loan');

      cy.get(`[data-cy="description"]`).type('India multi-byte').should('have.value', 'India multi-byte');
