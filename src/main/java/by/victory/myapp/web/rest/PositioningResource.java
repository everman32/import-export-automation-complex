...
public class PositioningResource {
    ...
    private final Logger log = LoggerFactory.getLogger(PositioningResource.class);
    ...
    public ResponseEntity<Positioning> createPositioning(@Valid @RequestBody Positioning positioning) throws URISyntaxException {
        ...
        Positioning result = positioningRepository.save(positioning);
        return ResponseEntity.created(new URI("/api/positionings/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/positionings/{id}", consumes = { "application/json", "application/merge-patch+json" })
     ...
     */
    @GetMapping("/positionings")
    public ResponseEntity<List<Positioning>> getAllPositionings(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/positionings/{id}")
    public ResponseEntity<Positioning> getPositioning(@PathVariable Long id) {
     ...
     */
    @DeleteMapping("/positionings/{id}")
    public ResponseEntity<Void> deletePositioning(@PathVariable Long id) {
