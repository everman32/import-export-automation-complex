...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTUNIT actions', async () => {
      const expectedActions = [
        {
