...
export const AddressDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="accountingImportExportProductsApp.address.delete.question">
        <Translate contentKey="accountingImportExportProductsApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
