...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './statement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATEMENT actions', async () => {
      const expectedActions = [
        {
