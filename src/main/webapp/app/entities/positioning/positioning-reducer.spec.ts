...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSITIONING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSITIONING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSITIONING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POSITIONING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POSITIONING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSITIONING actions', async () => {
      const arg = 42666;
