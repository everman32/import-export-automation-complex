...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATEMENTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STATEMENTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STATEMENTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STATEMENTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STATEMENTTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATEMENTTYPE actions', async () => {
      const arg = 42666;
