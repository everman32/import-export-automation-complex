...
export const ProductDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="accountingImportExportProductsApp.product.delete.question">
        <Translate contentKey="accountingImportExportProductsApp.product.delete.question" interpolate={{ id: productEntity.id }}>
