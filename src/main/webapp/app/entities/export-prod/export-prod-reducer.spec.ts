...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPORTPROD_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXPORTPROD actions', async () => {
      const expectedActions = [
        {
