...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMPORTPROD_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMPORTPROD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMPORTPROD actions', async () => {
      const expectedActions = [
        {
